...
"""
569 amostras
características: 30 imagens
rótulos: 0 para valores de tumor malígno e 
1 para valores de tumores benignos
"""

"""
O dataset tem características (data.data) e rótulos (data.target).
data.data: matriz de 30 características para cada amostra
data.target: valores 0 (maligno), 1(benigno) para cada amostra
...
print(f"\nA métrica de Precisão é: {precision:.2f}, significa que que temos poucos falsos positivos.")
print(f"\nA métrica de Sensibilidade é: {recall:.2f}, significa que temos poucos falsos negativos.")
print(f"\nA métrica F1 Score é: {f1:.2f}, significa um equilíbrio entre as métricas precision e recall.")
print(f"\nA métrica da àrea sob a curva ROC é: {auc:.2f}, significa a capacidade de distinguir as diferentes classes.")